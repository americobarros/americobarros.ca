<?php
	...
	$base_lang = 'en';
	$site_id = "2029e191";
	$websiteUID = "bc56ce95e30b6675b6f8bd680df3c02b14bf6df94c88d494b5db9dbe017e54de92f5312f6e7eedda";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'americobarros.ca';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "http://uk.zyro.com/comment_callback/";
	$user_key = "20jadA1f7GKvydtUFESBPQ==";
	$user_hash = "582e9ca2067ed7de";
